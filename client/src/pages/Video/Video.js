...
const Video = (props) => {
        ...
        function drawCircle(ctx, x, y, r, c, options, arc, start) {
        ...
        function drawLine(ctx, x1, y1, x2, y2, color, thickness, cap, alpha) {
        ...
        function drawRectangle(ctx, x, y, w, h, c, options) {
        ...
        function drawText(ctx, text, x, y, font, color, align, baseline, alpha) {
